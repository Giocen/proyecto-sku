document.getElementById('sku-form').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch('https://script.google.com/a/macros/liverpool.com.mx/s/AKfycbxSyUOOHbMMk3k5FMqlgKsxNtXtTo7XbmIRM77sw5LIB5MUcECYYPxT-HSSlQm6EHBTgQ/exec', {
      method: 'POST',
